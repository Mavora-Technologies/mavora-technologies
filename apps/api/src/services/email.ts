...
export async function sendLeadConfirmationEmail(toEmail: string, fullName: string) {
  try {
...
export async function sendProjectRequestConfirmationEmail(toEmail: string, fullName: string) {
  try {
...
export async function sendConsultationConfirmationEmail(toEmail: string, fullName: string, preferredDate: string) {
  try {
    if (!process.env.SMTP_USER || !process.env.SMTP_PASS) return;
