...
// Unique, text-free professional photography map tailored specifically to each individual context
const SERVICE_IMAGES: Record<string, string> = {
  'ai-development': 'https://images.unsplash.com/photo-1620712943543-bcc4688e7485', // Neural network & AI model visualization
  'ai-automation': 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e',   // Intelligent automated workflow / robotics
  'cloud-devops': 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8',    // DevOps pipeline & continuous deployment servers
  'cloud': 'https://images.unsplash.com/photo-1510915228340-29c85a43dbfe',          // Cloud infrastructure & scalable network grid
  'mobile-app-development': 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c', // Mobile app UI interface design
  'cybersecurity': 'https://images.unsplash.com/photo-1563986768609-322da13575f3',   // Security data stream & encryption
  'web-development': 'https://images.unsplash.com/photo-1498050108023-c5249f4df085', // Clean developer coding workspace
  'custom-software': 'https://images.unsplash.com/photo-1555066931-4365d14bab8c',   // Advanced programming architecture
  'data-analytics': 'https://images.unsplash.com/photo-1551288049-bebda4e38f71',    // Big data intelligence dashboard
  'legacy-modernization': 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d', // Enterprise server room transformation
};
...
export default async function ServiceDetailPage({ params }: ServicePageProps) {
  ...
  // Fallback priority: exact slug match -> general tech photo fallback
  const imageSrc = SERVICE_IMAGES[slug] || 'https://images.unsplash.com/photo-1451187580459-43490279c0fa';

  return (
    <div className="min-h-screen bg-[#EBF3FF] text-slate-900 overflow-hidden">
      {/* Hero Section with Context-Matching Real Image */}
      <section className="relative bg-[#EBF3FF] text-slate-900 py-20 lg:py-28 overflow-hidden border-b border-slate-200/80">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            {/* Right Column: Context-Matching Professional Image */}
            <div className="lg:col-span-5 relative">
              <div className="relative mx-auto w-full max-w-md lg:max-w-none rounded-2xl overflow-hidden shadow-2xl border border-slate-200/80 bg-white/50 backdrop-blur-md p-2">
                <Image 
                  src={imageSrc}
