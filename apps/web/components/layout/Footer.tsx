      ...
      <div className="container mx-auto max-w-7xl px-6 py-16 lg:py-20 relative z-10">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-slate-800 text-sm font-medium leading-relaxed italic border-l-2 border-blue-600 pl-3 py-0.5">
          ...
          <div>
            <h3 className="mb-6 text-xs font-bold uppercase tracking-widest text-slate-900 flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-600"></span> Company
            </h3>
            <ul className="flex flex-col gap-3.5 text-sm">
              ...
              <li><Link href="/services" className="hover:text-blue-700 transition-colors">Capabilities</Link></li>
              <li><Link href="/projects" className="hover:text-blue-700 transition-colors">Case Studies</Link></li>
              <li><Link href="/insights" className="hover:text-blue-700 transition-colors">Insights & Blog</Link></li>
          ...
          <div>
            <h3 className="mb-6 text-xs font-bold uppercase tracking-widest text-slate-900 flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-600"></span> Capabilities
            </h3>
            <ul className="flex flex-col gap-3.5 text-sm">
              <li>
                <Link href="/services/ai-automation" className="group flex items-center gap-2 hover:text-blue-700 transition-colors">
                  <ArrowRight className="size-3 text-blue-600 transition-transform group-hover:translate-x-1 shrink-0" /> AI & Automation
                </Link>
              </li>
              <li>
                <Link href="/services/software-development" className="group flex items-center gap-2 hover:text-blue-700 transition-colors">
                  <ArrowRight className="size-3 text-blue-600 transition-transform group-hover:translate-x-1 shrink-0" /> Enterprise Software
                </Link>
              </li>
              <li>
                <Link href="/services/cybersecurity" className="group flex items-center gap-2 hover:text-blue-700 transition-colors">
                  <ArrowRight className="size-3 text-blue-600 transition-transform group-hover:translate-x-1 shrink-0" /> Cybersecurity & Compliance
                </Link>
              </li>
              <li>
                <Link href="/services/cloud-it" className="group flex items-center gap-2 hover:text-blue-700 transition-colors">
                  <ArrowRight className="size-3 text-blue-600 transition-transform group-hover:translate-x-1 shrink-0" /> Cloud Platforms
                </Link>
              </li>
              <li>
                <Link href="/request-project" className="group flex items-center gap-2 text-blue-600 font-semibold hover:underline pt-1">
          ...
          <div>
            <h3 className="mb-6 text-xs font-bold uppercase tracking-widest text-slate-900 flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-600"></span> Headquarters
            </h3>
            <ul className="flex flex-col gap-3 text-xs text-slate-600">
              <li className="leading-relaxed text-slate-800 font-medium">Wood Garden Road, off Wood Avenue</li>
